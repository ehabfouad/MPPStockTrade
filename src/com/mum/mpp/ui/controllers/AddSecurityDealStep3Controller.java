 ...
 * @author villan
 */
public class AddSecurityDealStep3Controller implements Initializable {
	...
	private void next(ActionEvent event) {
		AddSecurityDealStep1Controller.secDealBank.setCustomerId(customerId.getText());
		AddSecurityDealStep1Controller.secDealBank.setPortfolioId(portfolioId.getText());
		AddSecurityDealStep1Controller.secDealBank.setAccountId(accountId.getText());
		App.appUtils.loadScene(FXMLRessources.TITLE_SECURITYDEAL4_ADD, FXMLRessources.FXML_SECURITYDEAL_STEP4);
	}
